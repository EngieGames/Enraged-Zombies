 ...
 *
 */
package net.mcreator.enragedzombies;
...
@Mod("enraged_zombies")
public class EnragedZombiesMod {
	public static final Logger LOGGER = LogManager.getLogger(EnragedZombiesMod.class);
	public static final String MODID = "enraged_zombies";

	public EnragedZombiesMod() {
		MinecraftForge.EVENT_BUS.register(this);
		EnragedZombiesModTabs.load();
