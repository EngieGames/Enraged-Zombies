...
import net.mcreator.enragedzombies.procedures.TNTSpawnTNTDeathProcedure;
import net.mcreator.enragedzombies.procedures.MutationChanceProcedure;
...
public class EnragedTNTEntity extends Monster {
	public EnragedTNTEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnragedZombiesModEntities.ENRAGED_TNT.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(EnragedZombiesModEntities.ENRAGED_TNT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
