...
public abstract class CommonEnragedItem extends ArmorItem {
	public CommonEnragedItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends CommonEnragedItem {
		public Helmet() {
	...
	public static class Chestplate extends CommonEnragedItem {
		public Chestplate() {
	...
	public static class Leggings extends CommonEnragedItem {
		public Leggings() {
	...
	public static class Boots extends CommonEnragedItem {
		public Boots() {
