...
public abstract class EpicEnragedItem extends ArmorItem {
	public EpicEnragedItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends EpicEnragedItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Epic"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "enraged_zombies:textures/models/armor/epicenraged__layer_1.png";
		}
	}

	public static class Chestplate extends EpicEnragedItem {
		public Chestplate() {
	...
	public static class Leggings extends EpicEnragedItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "enraged_zombies:textures/models/armor/epicenraged__layer_2.png";
		}
	}

	public static class Boots extends EpicEnragedItem {
		public Boots() {
