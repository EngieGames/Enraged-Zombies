...
public abstract class UncommonEnragedItem extends ArmorItem {
	public UncommonEnragedItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends UncommonEnragedItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Uncommon"));
		}
	...
	public static class Chestplate extends UncommonEnragedItem {
		public Chestplate() {
	...
	public static class Leggings extends UncommonEnragedItem {
		public Leggings() {
	...
	public static class Boots extends UncommonEnragedItem {
		public Boots() {
